...
![VMWare Workstation Player 1](/assets/uploads/VM_Post/VMWare/VMWare_1.webp)

Select the ISO and click "Next".

![VMWare Workstation Player 2](/assets/uploads/VM_Post/VMWare/VMWare_2.webp)

Select the Guest operating system as "Linux" with Version "Ubuntu 64-bit" and click on "Next".

![VMWare Workstation Player 3](/assets/uploads/VM_Post/VMWare/VMWare_3.webp)
...
![VMWare Workstation Player 6](/assets/uploads/VM_Post/VMWare/VMWare_6.webp)

![VMWare Workstation Player 7](/assets/uploads/VM_Post/VMWare/VMWare_7.webp)
...
![VMWare Workstation Player 10](/assets/uploads/VM_Post/VMWare/VMWare_10.webp)
...
![Virt manager 5](/assets/uploads/VM_Post/Virt-Manager/virt_manager_5.webp)

Specify the name of your virtual machine and confirm other options and click on "Finish".

![Virt manager 6](/assets/uploads/VM_Post/Virt-Manager/virt_manager_6.webp)

Now, wait for the virtual machine to get created.

![Virt manager 7](/assets/uploads/VM_Post/Virt-Manager/virt_manager_7.webp)
...
![Virt manager 9](/assets/uploads/VM_Post/Virt-Manager/virt_manager_9.webp)
...
![Parallels 2](/assets/uploads/VM_Post/Parallels/vanilla-parallels-install-2.webp)

Select "Choose Manually".

![Parallels 3](/assets/uploads/VM_Post/Parallels/vanilla-parallels-install-3.webp)

Click the "select a file..." hyperlink, or drag the `VanillaOS-<release>.iso` file to the Installation Assistant window.

![Parallels 4](/assets/uploads/VM_Post/Parallels/vanilla-parallels-install-4.webp)
...
![Parallels 9](/assets/uploads/VM_Post/Parallels/vanilla-parallels-install-9.webp)

Selecting "Create" will open the "Vanilla OS" Configuration window. Select the "Hardware" tab.

![Parallels 10](/assets/uploads/VM_Post/Parallels/vanilla-parallels-install-10.webp)

Scroll the left-side menu until you see "Boot Order".

![Parallels 11](/assets/uploads/VM_Post/Parallels/vanilla-parallels-install-11.webp)

From the "Boot Order" tab, click the "Advanced..." button

![Parallels 12](/assets/uploads/VM_Post/Parallels/vanilla-parallels-install-12.webp)

Change "BIOS: Legacy BIOS" to "EFI 64-bit".

![Parallels 13](/assets/uploads/VM_Post/Parallels/vanilla-parallels-install-13.webp)
...
![Parallels 16](/assets/uploads/VM_Post/Parallels/vanilla-parallels-install-16.webp)
...
![VirtualBox 4](/assets/uploads/VM_Post/Virtualbox/VirtualBox_4.webp)
...
| ![VirtualBox 6](/assets/uploads/VM_Post/Virtualbox/VirtualBox_6.webp) 	| ![VirtualBox 7](/assets/uploads/VM_Post/Virtualbox/VirtualBox_7.webp) 	|
|:---------------------------------------------------------------------:	|:---------------------------------------------------------------------:	|
| **Default order**                                                     	| **Recommended order**                                                 	|

![VirtualBox 8](/assets/uploads/VM_Post/Virtualbox/VirtualBox_8.webp)
...
![VirtualBox 9](/assets/uploads/VM_Post/Virtualbox/VirtualBox_9.webp)

Now, click the "Start" button to start your VM.

![VirtualBox 10](/assets/uploads/VM_Post/Virtualbox/VirtualBox_10.webp)
...
![VirtualBox 11](/assets/uploads/VM_Post/Virtualbox/VirtualBox_11.webp)

![VirtualBox 12](/assets/uploads/VM_Post/Virtualbox/VirtualBox_12.webp)
